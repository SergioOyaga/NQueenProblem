...
tibble_8Q=as_tibble(read.csv(file = "../../IdeaProjects/NQueenProblem/out/rFiles/file.csv",header = T))
tibble_8Q2=as_tibble(read.csv(file = "../../IdeaProjects/NQueenProblem/out/rFiles/file1.csv",header = T))
generations = 100 #Adjust the length to the number of generations used in the java code.
